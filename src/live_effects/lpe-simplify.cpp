...
LPESimplify::LPESimplify(LivePathEffectObject *lpeobject)
    ...
    , simplify_individual_paths(_("Simplify paths separately"), _("When there are multiple paths in the selection, simplify each one separately."), "simplify_individual_paths",
                                &wr, this, false)
