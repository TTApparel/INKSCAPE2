...
public:
    ...
    // user moves tab to this tab strip from a different tab strip
    sigc::signal<void (Gtk::Widget&, TabStrip&)> signal_move_tab() { return _signal_move_tab; }
...
private:
    ...
    sigc::signal<void (Gtk::Widget&, TabStrip&)> _signal_move_tab;
